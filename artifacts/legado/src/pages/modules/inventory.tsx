      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm">los registros diarios de inventario</p>
          </div>
        </div>
        <div className="bg-white rounded-xl border border-slate-100 p-12 text-center">
          ...
          <p className="text-slate-500 text-sm max-w-md mx-auto">
            El módulo de Cuadre de Inventario está siendo implementado. Aquí podrás gestionar los registros diarios de inventario.
          </p>
        </div>
      </div>
    </AppLayout>
